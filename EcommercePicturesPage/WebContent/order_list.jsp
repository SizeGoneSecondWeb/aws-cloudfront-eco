			...
			<div class="col-12">
				<nav class="breadcrumb bg-light mb-30">
					<a class="breadcrumb-item text-dark" href="home">Home</a> <a
						...
						class="breadcrumb-item active">View Order History</span>
				</nav>
			</div>
		</div>
	</div>
		...
		<div class="row px-xl-5">
			<div class="col-lg-12">
				<h5 class="section-title position-relative text-uppercase mb-3">
					<span class="bg-secondary pr-3">My Order History</span>
				</h5>
									...
									<c:forEach items="${listOrders}" var="order" varStatus="status">
										<tr>
											...
											<td class="align-middle"><a href="show_order_detail?id=${order.orderId}"
												class="btn btn-block btn-primary font-weight-bold my-3 py-3">View Details</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
