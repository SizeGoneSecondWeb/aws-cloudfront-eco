...
<html lang="en">
<head>
<title>Login - Pictures Shop LVl</title>
<meta charset="utf-8">
<meta name="viewport"
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Pictures Shop LVL Register</h2>
				</div>
			</div>
			<div class="row justify-content-center">
					...
					<div class="wrap d-md-flex">
						<div
							...
							<div class="text w-100">
								...
								<a href="signup.html" class="btn btn-white btn-outline-white">Sign
									Up</a>
							</div>
						</div>
